...
---
<!-- PREAMBLE
# Purpose: Create all data analyses, tables, and visualizations required for the final paper of INF 312.
# Author: Oliver Daniel
# Data: 2022-04-30
# Contact: through Quercus
# License: WTFPL
# Pre-requisites: 
# - A reasonably modern R installation, and all data found in the `in/` directory of this repository. All other dependencies should auto-install on run.
# - knitr
 -->
...
But, the above pair may also more succinctly be represented in-text by a form like (PL/GR)\_\_\_\_ when more appropriate.
